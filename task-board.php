			...
			<div class="content container-fluid">
				...
				<div class="row board-view-header">
					...
					<div class="col-8 text-right">
						...
						<a href="project-view.php" class="btn btn-white float-right" title="View Board"><i class="fa fa-link"></i></a>
					</div>
					<div class="col-12">
							...
							<div class="kanban-list kanban-danger">
								...
								<div class="kanban-wrap">
									<div class="card panel">
										<div class="kanban-box">
											<div class="task-board-header">
												<span class="status-title"><a href="task-view.php">Website redesign</a></span>
									...
									<div class="card panel">
										<div class="kanban-box">
											<div class="task-board-header">
												<span class="status-title"><a href="task-view.php">Make a wireframe</a></span>
												<div class="dropdown kanban-task-action">
													<a href="" data-toggle="dropdown">
														<i class="fa fa-angle-down"></i>
													</a>
